  ...
  return (
    <div className="flex flex-wrap flex-col w-full bg p-3 rounded-lg border-2 border-[#728CDF]">
      ...
      <div className="flex flex-wrap flex-row h-[155px] border-b-2 border-white">
        <Details
          returns={(boardroomAPR / (30 * 12)).toFixed(2)}
          stakeInNum={getDisplayBalance(stakedBalance)}
          stakeInDollar={tokenPriceInDollars}
          earnedInNum={getDisplayBalance(earnings)}
        ...
        <div className="flex flex-wrap w-3/6 justify-end items-end mb-5">
          <p className="inline-flex">
            Total Staked: <img src={BShares} alt="" className="h-5 w-5" />
            {totalStake}
          </p>
          ...
          <div className="inline-flex">
            <button
              ...
              onClick={approve}
              className={`border-2 rounded-full h-10 w-28 pt-1 pb-1 ml-2 ${
            ...
            <button
              ...
              onClick={onRedeem}
              className={`border-2 rounded-full h-10 w-28 pt-1 pb-1 ml-2 ${
                stakedBalance.eq(0) || !canWithdraw ? 'border-[#C3C5CBBF] text-[#C3C5CBBF]' : 'border-white text-white'
              }`}
            >
              Withdraw&nbsp;&nbsp;&nbsp;
          ...
          <button
            ...
            className={`border-2 rounded-full h-10 w-[14.5rem] pt-1 pb-1 ${

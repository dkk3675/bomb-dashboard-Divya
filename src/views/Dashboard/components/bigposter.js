  ...
  return (
    <div className="flex flex-wrap flex-col w-full mt-5 mb-14">
      ...
      <div className="flex flex-wrap flex-row h-40 border-b-2 border-white">
        <Details
          returns={returns}
          stakeInNum={stakeInNum}
          stakeInDollar={stakeInDollar}
          earnedInNum={earnedInNum}
          earnedInDollar={earnedInDollar}
          stakeIcon={stakeIcon}
        ...
        <div className="flex flex-wrap w-3/6 justify-center items-end mb-5">
          ...
          <button onClick={onRedeem} className="border-2 border-white rounded-full h-10 w-36 pt-1 pb-1 ml-1">
            Withdraw&nbsp;&nbsp;&nbsp;
          ...
          <button
            ...
            className={`border-2 rounded-full h-10 w-36 pt-1 pb-1 ml-1 ${
              earnings.eq(0) ? 'border-[#C3C5CBBF] text-[#C3C5CBBF]' : 'border-white text-white'
            }`}
          >
